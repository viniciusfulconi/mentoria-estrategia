  ...
  return (
    <div style={{ paddingBottom: 80 }}>
      <div style={{ background:'white', borderBottom:'0.5px solid rgba(0,0,0,0.08)', padding:'16px', position:'sticky', top:0, zIndex:10, display:'flex', justifyContent:'space-between', alignItems:'center' }}>
        ...
        <Link href="/turmas/nova" style={{ textDecoration:'none', background:'#534AB7', color:'white', borderRadius:10, padding:'7px 14px', fontSize:13, fontWeight:500 }}>+ Nova</Link>
      </div>
      <div style={{ padding:16 }}>
        ...
        : turmas.length === 0 ? (
          <div className="card" style={{ textAlign:'center', color:'#999', padding:40 }}>
            ...
            <Link href="/turmas/nova" style={{ textDecoration:'none', display:'inline-block', marginTop:14, background:'#534AB7', color:'white', borderRadius:12, padding:'10px 20px', fontSize:14 }}>Criar turma</Link>
          </div>
        ) : turmas.map((t:any) => (
