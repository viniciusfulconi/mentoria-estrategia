  ...
  return (
    <div style={{ paddingBottom:80 }}>
      <div style={{ background:'white', borderBottom:'0.5px solid rgba(0,0,0,0.08)', padding:'16px', position:'sticky', top:0, zIndex:10, display:'flex', justifyContent:'space-between', alignItems:'center' }}>
        ...
        <Link href="/mentores/novo" style={{ textDecoration:'none', background:'#534AB7', color:'white', borderRadius:10, padding:'7px 14px', fontSize:13, fontWeight:500 }}>+ Novo</Link>
      </div>
      <div style={{ padding:16 }}>
        ...
        : mentores.length === 0 ? (
          <div className="card" style={{ textAlign:'center', color:'#999', padding:40 }}>
            ...
            <Link href="/mentores/novo" style={{ textDecoration:'none', display:'inline-block', marginTop:14, background:'#534AB7', color:'white', borderRadius:12, padding:'10px 20px', fontSize:14 }}>Adicionar mentor</Link>
          </div>
        ) : mentores.map((m:any) => (
          <div key={m.id} className="card" style={{ marginBottom:10 }}>
            <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:10 }}>
              <div style={{ width:40, height:40, borderRadius:'50%', background:'#EEEDFE', display:'flex', alignItems:'center', justifyContent:'center', fontSize:12, fontWeight:600, color:'#3C3489', flexShrink:0 }}>
            ...
            <div style={{ borderTop:'0.5px solid rgba(0,0,0,0.06)', paddingTop:10, display:'flex', flexDirection:'column', gap:6 }}>
              ...
              <div style={{ display:'flex', justifyContent:'space-between', fontSize:12 }}>
                ...
                <span style={{ color:'#EF9F27', fontWeight:500 }}>{stars(m.nota_media||0)} {Number(m.nota_media||0).toFixed(1)}</span>
              </div>
            </div>
          </div>
        ))}
