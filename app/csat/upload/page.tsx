...
export default function UploadCSAT() {
    ...
    reader.onload = (ev) => {
      ...
      const parsed = rows.map(r => {
        ...
        return {
          ...
          q_rapidez:    Number(get('Rapidez nas respostas') || 0),
          ...
          q_personaliz: Number(get('Personalização para sua realidade') || 0),
  ...
  async function salvar() {
    ...
    const records = preview.map(r => ({
      ...
      aluno: r.aluno,
      mentor: r.mentor,
      rapidez_respostas:        r.q_rapidez || null,
      ...
      personalizacao_realidade: r.q_personaliz || null,
