      ...
      <div style={{ padding: 16 }}>
        {loading ? (
          ...
          <div className="card" style={{ textAlign: 'center', padding: 40 }}>
            ...
            <button onClick={load} style={{ padding: '8px 20px', borderRadius: 10, background: '#f97316', color: 'white', border: 'none', fontSize: 13, cursor: 'pointer' }}>Tentar novamente</button>
          </div>
        ) : filtrados.length === 0 ? (
